...
class UCM_Context_Model(nn.Module):
    ...
    def get_3d_checkerboard_groups(self, coords):
        ...
        group1_mask = (coord_sum & 1) == 0
        group2_mask = ~group1_mask
        return group1_mask, group2_mask

    def aggregate_neighbor_features_efficient(self, coords, features, group1_mask, group2_mask, occupancy, cache=None):
        """
        Args:
        ...
        if cache is not None and hasattr(masked_sparse, '_caches'):
            masked_sparse._caches = cache
